 ...
 * Integrates AI-Enhanced monitoring for experimental env
 */
...
// Check if environment is valid, default to production if not
const config = monitorConfig[ENV] || monitorConfig.production;
const effectiveEnv = monitorConfig[ENV] ? ENV : 'production';

console.log('=================================');
console.log(`DevOps Simulator - Monitor`);
console.log(`Environment: ${effectiveEnv}`);
if (effectiveEnv === 'experimental') {
...
// Simulated ML prediction (only used by experimental mode)
...
function checkSystemHealth() {
  ...
  if (effectiveEnv === 'experimental') {
    ...
    // === PRODUCTION/DEVELOPMENT HEALTH CHECK ===
    if (config.debugMode) {
...
// Initialize AI models (only for experimental)
if (effectiveEnv === 'experimental' && config.aiEnabled) {
